...
<?php $this->load->view('admin/sections/head.php')?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Damage </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <li class="breadcrumb-item active"><a href="#">Dashboard</a></li>
                ...
                <!-- Main content -->
                  ...
                  <div class="container p-4">
                          ...
                          <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href=""><h6 class="text-center">Display Damage Details</h6></a>
                                </div>
                                <!-- /.card-header -->
                                 <!-- form start -->
                                <form role="form" id="form" action="<?php echo base_url().'admin/Damage/save'?>" method="post" enctype="multipart/form-data">
                                  <div class="card-body">
                                    <div class="row">                                           
                                     <div class="col-md-4">
                    ...
                    <input type="date" name="damage_date" class="form-control float-right" id="reservation">
                  </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Damage Particulars</label>
                                              <input type="text" name="damage_parti" class="form-control" placeholder="Enter Damage Particulars"  required />
                                        </div>
                                      </div>
                                        <div class="col-md-4">
                                        <div class="form-group">
                                        ...
                                        <h5>Whether Workman Showed Couse Against Deduction</h5>
                                         <label class="radio-inline">
                                            <input type="radio" name="workman" value="yes">Yes
                                          </label>
                                          <label class="radio-inline">
                                            <input type="radio" name="workman" value="no">No
                                          </label>
                                          </center>
                                        </div>
                                      </div>
                        ...
                        <div class="row">
                              ...
                              <div class="container">
                                  <div class="row">          
                                   ...
                                   <!--  <th>Employee</th> -->      
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                                aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Damage Date</th> 
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                                aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Amount</th> 
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                                aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Damage Particulars</th>
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                ...
                                <tbody>
                                 ...
                                 foreach($damage as $row)
                                 {
                                   ...
                                   <!--  <td><?=$row['emp_id']?></td>   -->
                                    ...
                                    <td>
                                      <a href="<?=base_url()?>admin/damage/edit/<?=md5($row['dam_id'])?>"><button type="button" class="btn btn-info btn-xs">Edit</button></a>                     
                                   </td>
                                  </tr>
                                  <?php }?>
                                </tbody>
