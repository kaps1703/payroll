...
<tbody><tr>
<td>
 <form action="<?php echo base_url();?>admin_panel/PermissionController/permissionsubmitEdit" onSubmit="return check_form_valid()" method="post"   id="form-validate" enctype="multipart/form-data">  
<!-- Addresses forms Add category form -->
    <div class="entry-edit" id="address_form_container">
            <div style="" id="form_new_item1">
        <div class="entry-edit-head">
    <h4 class="icon-head head-edit-form fieldset-legend">ADD Permission</h4>
    ...
    <div class="hor-scroll">
      <table class="form-list" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td class="label"><label for="_item1prefix">Permission</label></td>
                                      <td class="value"><input id="permission" name="permission" class="input-text required" type="text" value="<?php echo $data[0]['permission']?>">
                                      <input type="hidden" id="permission_id" name="permission_id" value="<?php echo $data[0]['permission_id']?>"
                                      </td>
