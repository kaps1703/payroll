                        ...
                        <!-- left column -->
                          ...
                          <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href=""><h6 class="text-center">Services Details</h6></a>
                                </div>
                                <!-- /.box-header -->
                                 <!-- form start -->
                                <form role="form" id="form" action="<?php echo base_url().'admin/Add_services/save'?>" method="post" enctype="multipart/form-data">
                                  <div class="card-body">
                                    <div class="row">                                           
                                      <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Service Name</label>
                                              <input type="text" name="servicename" class="form-control" placeholder="Enter Services"  required />
                                        </div>
                                      </div>
                                     </div>
</div>
                                 ...
                                 <div class="container">
                                  <div class="row">          
                                   ...
                                   <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                                aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Service Name</th>              
                         ...
                         ?>
                                 ...
                                 <tr role="row" class="odd">
                                    ...
                                    <td>
                                      <a href="<?=base_url()?>admin/Add_services/edit/<?=md5($row['id'])?>"><button type="button" class="btn btn-info btn-xs">Edit</button></a>                     
