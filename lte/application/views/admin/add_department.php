                        ...
                        <!-- left column -->
                          ...
                          <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href=""><h6 class="text-center">Departments Details</h6></a>
                                </div>
                                <!-- /.box-header -->
                                 <!-- form start -->
                                <form role="form" id="form" action="<?php echo base_url().'admin/Add_department/save'?>" method="post" enctype="multipart/form-data">
                                  <div class="card-body">
                                    <div class="row"> 
                                     <div class="col-md-6">
                                      ...
                                      <div class="col-md-3">
                                       <p style="cursor: pointer; margin-top: 25px;"><a>Latitude</a>/<a>Longitude</a></p>
                                      </div>
                                     </div>
</div>
                         ...
                         ?>
                                 <tr role="row" class="odd">
                                    ...
                                    <td>
                                      <a href="<?=base_url()?>admin/Add_department/edit/<?=md5($row['dept_id'])?>"><button type="button" class="btn btn-info btn-xs">Edit</button></a>                     
                                     <!--                                          -->
                                   </td>
                                  </tr>
                                  <?php }?>
