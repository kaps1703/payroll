...
<?php $this->load->view('admin/sections/head.php')?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">       <div class="wrapper">
                ...
                <section class="content" style="background: white">
                        ...
                        <!-- left column -->
                            ...
                            <div class="card">
                               <div class="card-header" style="text-align: center">
                                ...
                                <!-- /.card-header -->
                                 <!-- form start -->
                                <form role="form" id="form" action="<?php echo base_url().'admin/Allot_material/edit_save'?>" method="post" enctype="multipart/form-data">
                                  <div class="card-body">
                                    <div class="row">                                           
                                     <div class="col-md-4">
                               ...
                               { ?>
                                <option <?php if($data2[$i]['d_id'] == $data[0]['d_id']) echo 'selected="selected"'; ?> value="<?php echo $data2[$i]['d_id'] ;?>"><?php echo $data2[$i]['designation_name'] ;?></option>
                               <?php } ?>
                                             </select>
                                          </div>
                                        </div>
                               ...
                               { ?>
                                <option <?php if($data3[$i]['emp_id'] == $data[0]['emp_id']) echo 'selected="selected"'; ?> value="<?php echo $data3[$i]['emp_id'] ;?>"><?php echo $data3[$i]['emp_name'] ;?></option>
                               <?php } ?>
                                             </select>
                                          </div>
                                        </div>
                    ...
                    <input type="date" name="mat_to_date" class="form-control float-right" id="reservation">
                                 ...
                                 <div class="col-md-4">
                                          ...
                                          for($i=0;$i< sizeof($data3);$i++)
                               { ?>
                                <option <?php if($data4[$i]['m_id'] == $data[0]['m_id']) echo 'selected="selected"'; ?> value="<?php echo $data4[$i]['m_id'] ;?>"><?php echo $data4[$i]['material_name'] ;?></option>
                               <?php } ?>
                                             </select>
                                          </div>
                                        </div>
