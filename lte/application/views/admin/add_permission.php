...
<tbody><tr>
<td>
 <form action="<?php echo base_url();?>admin_panel/PermissionController/permissionsubmit" onSubmit="return check_form_valid()" method="post"   id="form-validate" enctype="multipart/form-data">  
      ...
      <table class="form-list" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      ...
                                      <td class="value"><input id="permission" name="permission" class="input-text required" type="text">
                                      </td>
                                    </tr>
